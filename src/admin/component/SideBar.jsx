  ...
  return (
    <div className='w-[18%] min-h-screen  border-r-2'>
        <div className=' flex flex-col gap-4 pt-6 pl-[20%] text-[15px]'>
            ...
            <NavLink className='flex pp items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-l ' to={'/admin/heros'}>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3I10OL6FXfHXkz6wS_UOl3-eFEZE43LFtaQ&s" className='w-5 h-5' alt="" />
            <p className='hidden md:block'>add Hero</p>
            </NavLink>
